...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['Link'] = this.createHubProxy('Link'); 
        proxies['Link'].client = { };
        proxies['Link'].server = {
            subscribe: function (feedId) {
                return proxies['Link'].invoke.apply(proxies['Link'], $.merge(["Subscribe"], $.makeArray(arguments)));
             },

            unsubscribe: function (feedId) {
                return proxies['Link'].invoke.apply(proxies['Link'], $.merge(["Unsubscribe"], $.makeArray(arguments)));
             }
        };
